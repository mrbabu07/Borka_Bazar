        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-4 mt-6">
              <button 
                onClick={() => handleSocialClick("https://www.facebook.com/anamulhaque.joy.188?rdid=GvkM4bROFIYCRxEl&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F1FBQeH3fwk%2F")}
              ...
              <button 
                onClick={() => handleSocialClick("https://www.tiktok.com/@anamulhaquejoy359?_r=1&_t=ZS-95KcW5yHJPZfb")}
                className="w-10 h-10 flex items-center justify-center border border-white/20 hover:border-gold-500 hover:text-gold-500 transition-colors" 
                title="TikTok"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <button 
                onClick={() => handleSocialClick("https://api.whatsapp.com/message/OSBDQIJSDBKUP1?autoload=1&app_absent=0")}
                className="w-10 h-10 flex items-center justify-center border border-white/20 hover:border-gold-500 hover:text-gold-500 transition-colors" 
                title="WhatsApp"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
