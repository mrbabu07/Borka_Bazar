      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Dubai Borka Bazar Hnila is Bangladesh's premier online marketplace for authentic Burkas,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          <div>
            ...
            <p className="text-gray-600 mb-4">
              ...
              Bangladesh, Dubai Borka Bazar Hnila started as a specialized initiative to provide
            ...
            <p className="text-gray-600">
              Our name "Dubai Borka Bazar Hnila" reflects our specialization in providing
          ...
          <div className="bg-gradient-to-br from-primary-50 to-secondary-50 rounded-2xl p-8">
            <h4 className="text-xl font-semibold text-gray-900 mb-6">
              Why Choose Dubai Borka Bazar Hnila?
            </h4>
        ...
        <div className="bg-gradient-to-r from-primary-500 to-secondary-500 rounded-2xl p-8 text-white mb-16">
          <h3 className="text-2xl font-bold text-center mb-8">
            Dubai Borka Bazar Hnila by Numbers
          </h3>
