      ...
      const orderRes = await axios.post(
        `${API_BASE_URL}/orders`,
        {
          ...
          shippingInfo: {
            ...
            division: testData.customer.division,
            district: testData.customer.district,
            upazila: testData.customer.upazila,
            union: testData.customer.union,
          ...
          transactionId: testData.order.transactionId,
          senderNumber: testData.order.senderNumber,
          receiverNumber: testData.order.receiverNumber,
        },
        {
